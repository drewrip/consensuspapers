...
\tikzstyle{army} = [rectangle, text centered, minimum height=1cm, minimum width=2cm, draw=black]
...
\begin{center}
	...
	\node (armyA) [army, below of=con, yshift=-1cm, xshift=-1.75cm] {Army A};
	\node (armyB) [army, right of=armyA, xshift=2cm] {Army B};
	\draw [arrow] (armyA) -- node[anchor=south] {Msg A} (armyB);
	\draw [arrow, yshift=-.5cm] (armyB) -- node[anchor=south] {Msg B} (armyA);
	\end{tikzpicture}
\end{center}

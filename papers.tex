...
\begin{itemize}
	...
	In an analysis of many popular distributed systems, they found that many, while extensively tested, still have many faults present.
	...
	NEAT is a testing framework that intelligently injects network-parition faults into a distributed system in order to more efficiently and accurately identify potential errors in the implementation of a distributed system.

...
\begin{center}
	...
	\draw [transform canvas={yshift=0.2cm}, arrow] (armyA.east) -- node[anchor=south] {Msg A} (armyB.west);
	\draw [transform canvas={yshift=-0.5cm}, arrow] (armyB.west) -- node[anchor=south] {Msg B} (armyA.east);
	\draw [arrow] (armyA.north) -- node[anchor=south] {Attack} (con);
	\end{tikzpicture}
\end{center}
